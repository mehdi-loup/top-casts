 ...
 */
export const APP_NAME = 'top-casts';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION = 'Discover the best casts of the day';
 ...
 */
export const APP_TAGS = ['discover', 'social', 'curated', 'best'];
 ...
 */
export const APP_BUTTON_TEXT = 'Start';
